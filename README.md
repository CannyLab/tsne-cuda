...
You can install binaries with anaconda for CUDA version 10.1, 10.2, 11.0 and 11.2 using `conda install tsnecuda -c cannylab`. Tsnecuda supports CUDA versions 9.0 and later through source installation, check out the wiki for up to date installation instructions. [https://github.com/CannyLab/tsne-cuda/wiki/](https://github.com/CannyLab/tsne-cuda/wiki/)
